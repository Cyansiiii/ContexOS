...
# Fix: ChromaDB's chroma_server_nofile field has no type annotation,
# which crashes pydantic v1 on Windows/Python 3.14. Setting it as an
# env var with an empty string prevents the crash.
...
try:
    ...
    llm = OllamaLLM(model="phi3:mini")  # Local AI, no internet needed
...
def store_memory(text, metadata):
    ...
    if vectorstore is not None:
        ...
        # Note: langchain-chroma 0.2+ auto-persists, no need to call .persist()
